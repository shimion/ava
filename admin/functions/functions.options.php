...
// Set the Options Array
	   ...
	   $of_options[] = array( "name" => __("Testimonials Shortcode", "Avada"),
		...
		$of_options[] = array( "name" => __("Blog Sidebar 1", "Avada"),
		...
		$of_options[] = array( "name" => __("Blog Sidebar 2", "Avada"),
		...
		$of_options[] = array( "name" => __("Grid Pagination Type", "Avada"),
			"desc" => __("Select the pagination type for Portfolio Grid layouts.", "Avada"),
...
// Theme Specific Options
		...
		$of_options[] = array( "name" => __("Default Sidebar Position", "Avada"),
			"desc" => __("Select the default sidebar 1 position.", "Avada"),
		...
		$of_options[] = array( "name" => __("Disable Date Rich Snippet on Pages", "Avada"),
		...
		$of_options[] = array( "name" => __("BBPress Use Global Sidebar", "Avada"),
			"desc" => __("Check the box if you want to use one global sidebar on all forum pages.", "Avada"),
			"id" => "bbpress_global_sidebar",
			"std" => 0,
			"type" => "checkbox");

		$of_options[] = array( "name" => __("BBPress Global Sidebar 1", "Avada"),
		...
		$of_options[] = array( "name" => __("BBPress Global Sidebar 2", "Avada"),
