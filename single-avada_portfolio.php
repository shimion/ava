		...
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<div class="fusion-flexslider flexslider post-slideshow">
				<ul class="slides">
					...
					<?php endif; ?>
					<?php if( ( has_post_thumbnail() && get_post_meta($post->ID, 'pyre_video', true) && get_post_meta($post->ID, 'pyre_show_first_featured_image', true) != 'no' ) || ( has_post_thumbnail() && ! get_post_meta($post->ID, 'pyre_video', true) ) ): ?>
