...
if( ! class_exists( 'FusionMegaMenuFramework' ) ) {
	...
	class FusionMegaMenuFramework {
		...
		function register_scripts() {
			...
			// scripts
			wp_enqueue_media();
			wp_register_script( 'fusion-megamenu', self::$_urls['admin-js'] . '/mega-menu.js', array( 'jquery' ), '1.0.0', true );
			wp_enqueue_script( 'fusion-megamenu' );
		}
		...
		function register_stylesheets() {
			...
			wp_enqueue_style( 'fusion-megamenu', self::$_urls['admin-css'] . '/mega-menu.css', false, '1.0' );
