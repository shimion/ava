...
class FusionSC_Tagline {
	...
	function render( $args, $content = '') {
		...
		$html = sprintf('%s<div %s><section %s>%s%s</section></div>', $styles, FusionCore_Plugin::attributes( 'tagline-shortcode' ), FusionCore_Plugin::attributes( 'tagline-shortcode-reading-box' ), $additional_content, do_shortcode( $content ) );
