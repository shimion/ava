	...
	class FusionCoreFrontendWalker extends Walker_Nav_Menu {
		...
		public function end_lvl( &$output, $depth = 0, $args = array() ) {
			...
			if( $depth === 0  && $this->menu_megamenu_status == "enabled" ) {
				...
				$output = str_replace( "{first_level}", "<div class='fusion-megamenu-wrapper {fusion_columns} columns-".$this->total_num_of_columns . " columns-per-row-" . $this->max_num_of_columns . $col_span . " container' data-maxwidth='" . $megamenu_width . "'><div class='row'>", $output );
				if ( $this->total_num_of_columns > $this->max_num_of_columns ) {
